...
public class VideoStore<SuperVIP> {
	...
	public SuperVIP getSuperVIP(String ID) {
		return customerList.getSuperVIP(ID);
	}
	...
	public static void main(String[] args) {
		...
		//create 3 customers
		Customer cust = new SuperVIP("Ngo Bao Chau", "12 Math Avenue", "VIP001", "0203050813");
